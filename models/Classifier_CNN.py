...
class Classifier_CNN(BaseModel):
    ...
    def __init__(self, data, params: dict, **kwargs)->None:
        ...
        self.name               = params.get("name","Classifier_CNN")
        ...
        # Model
        print(f"Building model: {Classifier_CNN.get_model_name()} [{Classifier_CNN.get_model_type()}]")
        self.create_model()
    ...
    def train(self):
        print(f"Training model: {Classifier_CNN.get_model_name()} [{Classifier_CNN.get_model_type()}]")
    ...
    def store(self):
        ...
        print(f"saving weights of model {Classifier_CNN.get_model_name()}: {self.name}")
    ...
    def load(self):
        ...
        print(f"restoring weights of model {Classifier_CNN.get_model_name()}: {self.name}")
    ...
    def get_model_name(cls):
        return "Classifier_CNN" # Aquí se puede indicar un ID que identifique el modelo
