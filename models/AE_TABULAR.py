...
class AE_TABULAR(BaseModel):
    
    def __init__(self,data, params:dict,**kwargs):
        
        #General params
        self.name        = params.get("name","AE_TABULAR")
        self.params      = params
        #Data params
        self.data = data
        ...
        # Model
        print(f"Building model: {AE_TABULAR.get_model_name()} [{AE_TABULAR.get_model_type()}]")
        self.create_model()
    ...
    def train(self):
        print(f"Training model: {AE_TABULAR.get_model_name()} [{AE_TABULAR.get_model_type()}]")
    ...
    def store(self):
        ...
        print(f"saving weights of model {AE_TABULAR.get_model_name()}: {self.name}")
    ...
    def load(self):
        ...
        print(f"restoring weights of model {AE_TABULAR.get_model_name()}: {self.name}")
    ...
    def get_model_name(cls):
        return "AE_TABULAR" # Aquí se puede indicar un ID que identifique el modelo
