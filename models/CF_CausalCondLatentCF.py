...
from src.utils import polynomial_decay


class CF_CausalCondLatentCF():
    """
        Counterfactual generator using a conditioned Latent Space

    """
    def __init__(self, classifier: Classifier_CNN, gen: BaseModel, causal_index_map, params: dict, **kwargs)->None:
    ...
    def fit(self):
        ...
        """
        print(f"Building model: {CF_CausalCondLatentCF.get_model_name()} [{CF_CausalCondLatentCF.get_model_type()}]")
        #ipdb.set_trace()
    ...
    def get_model_name(cls):
        return "CF_CausalCondLatentCF" # Aquí se puede indicar un ID que identifique el modelo
