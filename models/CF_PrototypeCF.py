...
from src.utils import pairwise_l2_norm2,polynomial_decay

class CF_PrototypeCF():
    """
    ...
    """
    def __init__(self, classifier: Classifier_CNN, gen: BaseModel, params: dict, x, y, **kwargs)->None:
    ...
    def fit(self,x,y):
        ...
        """
        print(f"Building model: {CF_PrototypeCF.get_model_name()} [{CF_PrototypeCF.get_model_type()}]")
