...
class CF_CondLatentCF():
    """
        Counterfactual generator using a conditioned Latent Space

    """
    def __init__(self, classifier: Classifier_CNN, gen: BaseModel, params: dict, **kwargs)->None:
    ...
    def fit(self):
        ...
        """
        print(f"Building model: {CF_CondLatentCF.get_model_name()} [{CF_CondLatentCF.get_model_type()}]")
        #ipdb.set_trace()
    ...
    def get_model_name(cls):
        return "CF_CondLatentCF" # Aquí se puede indicar un ID que identifique el modelo
